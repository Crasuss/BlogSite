...
namespace web1.Controllers
{
    public class AdminYorumController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(yorums.OrderByDescending(y=>y.Tarih).ToList());
        }
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.Uyeid = new SelectList(db.Uyes, "Uyeid", "KullanıcıAdi");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Yorumid,Icerik,Uyeid,Makaleid,Tarih")] Yorum yorum)
        {
            ...
            ViewBag.Uyeid = new SelectList(db.Uyes, "Uyeid", "KullanıcıAdi", yorum.Uyeid);
            return View(yorum);
        }
